...
> **导航**
>
> 📍 **Java后端** · 第 2/29 步 · [完整路径](./路径-Java后端.md)
> ← [1.Java·知](./Java高频面试题与知识点.md)
> → [2.并发·知](./并发高频面试题与知识点.md)
>
> 📘 [知识点](./Java高频面试题与知识点.md)
>
...
> 历史合集（归档）：[Java高频面试口述答案-归档.md](./archive/Java高频面试口述答案-归档.md)  
> 每题 2～4 分钟
